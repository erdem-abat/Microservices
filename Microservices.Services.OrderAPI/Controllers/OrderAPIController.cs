    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public ResponseDto? Get(string? userId = "")
        {
            try
            {
                ...
                {
                    objList = _db.OrderHeaders.Include(x => x.OrderDetails).OrderByDescending(y => y.OrderHeaderId).ToList();
                }
                else
                {
                    objList = _db.OrderHeaders.Include(x => x.OrderDetails).Where(u => u.UserId == userId).OrderByDescending(v => v.OrderHeaderId).ToList();
                }
